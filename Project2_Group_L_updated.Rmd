...
According to the tables above, we can find that, as the fat level increasing, the calorie means for each level are increasing. But the carbohydrate is opposite, as the carbohydrate level increasing, the calorie means for each level are decreasing.
