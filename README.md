...
```
    ...
    ## #   readyInMinutes <int>, WW_category <dbl>
...
```
    ...
    ## # … with 40 more rows, and 10 more variables: sourceName <chr>, pricePerServing <dbl>,
    ## #   readyInMinutes <int>, WW_category <dbl>, image <chr>, imageType <chr>, calories <int>,
